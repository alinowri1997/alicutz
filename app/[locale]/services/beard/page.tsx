...
const PAGE_KEY: SeoPageKey = "beard";

interface BeardPageProps {
  params: Promise<{locale: string}>;
}

export async function generateMetadata({params}: BeardPageProps): Promise<Metadata> {
...
export default async function BeardPage({params}: BeardPageProps): Promise<React.JSX.Element> {
  const {locale: rawLocale} = await params;
