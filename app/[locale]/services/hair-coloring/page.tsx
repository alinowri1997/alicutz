...
const PAGE_KEY: SeoPageKey = "hairColoring";

interface HairColoringPageProps {
  params: Promise<{locale: string}>;
}

export async function generateMetadata({params}: HairColoringPageProps): Promise<Metadata> {
...
export default async function HairColoringPage({params}: HairColoringPageProps): Promise<React.JSX.Element> {
  const {locale: rawLocale} = await params;
