...
const PAGE_KEY: SeoPageKey = "services";

interface ServicesLandingPageProps {
  params: Promise<{locale: string}>;
}

export async function generateMetadata({params}: ServicesLandingPageProps): Promise<Metadata> {
...
export default async function ServicesLandingPage({params}: ServicesLandingPageProps): Promise<React.JSX.Element> {
  const {locale: rawLocale} = await params;
